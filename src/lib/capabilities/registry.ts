...
const CAPABILITIES: ScientificCapability[] = [
  ...
  mag({
    ...
    scientificConstraints: [
      ...
      "This is simple Bouguer (infinite slab). It is not complete Bouguer.",
      "Terrain correction is the separate grav.terrain capability and is off unless requested.",
  ...
  mag({
    id: "grav.terrain",
    version: "1.0.0",
    title: "Near-zone complete Bouguer (terrain correction)",
    description:
      "Nagy 1966 rectangular-prism terrain correction inside a user radius, added to simple Bouguer. Far-zone/Hayford–Bowie is not implemented.",
    domain: "gravity",
    ...
    outputs: [
      { id: "complete_bouguer", type: "table", description: "Near-zone complete Bouguer mGal", viewer: "table" },
      { id: "terrain_qc", type: "qc", description: "Terrain-correction method, radius, DEM identity, coverage", viewer: "json" },
    ],
    parameters: {
      density: { type: "number", required: true, description: "Reduction density. Never assumed.", units: "g/cm3" },
      terrainRadiusM: {
    ...
    scientificConstraints: [
      "Convention: Δg_CBA(near-zone) = Δg_FA − 2πGρh [+ Bullard B if requested] + TC_Nagy(R).",
      "TC is |gz| of DEM-minus-slab prisms (Nagy 1966) inside R. Always ≥ 0.",
      "Far-zone / Hayford–Bowie compartments are not implemented. This is not a global complete Bouguer.",
    ...
    interpretationLimits: [
      "Near-zone complete Bouguer is not lithology, mineralisation, or a drill target.",
      "Do not equate this product with Oasis montaj complete Bouguer or a far-zone-corrected anomaly.",
    ],
    expectedArtifacts: ["gravity_complete.csv", "gravity_terrain_qc.json", "complete_bouguer_grid.asc"],
  }),
  mag({
    id: "grav.grid",
    version: "1.0.0",
    ...
    expectedArtifacts: ["bouguer_grid.asc", "free_air_grid.asc", "complete_bouguer_grid.asc", "gravity_grid_qc.json"],
  ...
  mag({
    ...
    interpretationLimits: [
      ...
      "Simple Bouguer and near-zone complete Bouguer are different products and must not be labelled interchangeably.",
    ],
