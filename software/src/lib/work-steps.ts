...
const NODE_LABELS: Record<string, { running: string; done: string }> = {
  ...
  raster_inspect: { running: "Inspecting GeoTIFF/ASCII metadata", done: "Wrote raster inspect QC" },
  raster_view: { running: "Building raster viewer metadata", done: "Wrote raster viewer metadata" },
  terrain_view: { running: "Building documented DEM terrain viewer metadata", done: "Wrote terrain viewer metadata" },
