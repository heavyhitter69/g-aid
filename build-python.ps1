...
python -m poetry run pyinstaller -y --name g-aid-engine --onedir --hidden-import="pandas" --hidden-import="openpyxl" --hidden-import="openpyxl.drawing.image" --hidden-import="et_xmlfile" --hidden-import="langchain" --hidden-import="langchain_ollama" --hidden-import="langgraph" --hidden-import="uvicorn.logging" --hidden-import="uvicorn.loops" --hidden-import="uvicorn.loops.auto" --hidden-import="uvicorn.protocols" --hidden-import="uvicorn.protocols.http" --hidden-import="uvicorn.protocols.http.auto" --hidden-import="uvicorn.protocols.websockets" --hidden-import="uvicorn.protocols.websockets.auto" --hidden-import="uvicorn.lifespan" --hidden-import="uvicorn.lifespan.on" --hidden-import="uvicorn.lifespan.off" main.py
