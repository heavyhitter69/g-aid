"""IGRF-13 Gauss coefficients at 2020.0 and secular variation 2020-2025.

Source: IAGA 13th Generation International Geomagnetic Reference Field,
NOAA igrf13coeffs.txt (Alken et al., Earth Planets Space, 2021).
Units: nT (main field), nT/year (SV). Schmidt quasi-normalized.
"""

from __future__ import annotations

# (n, m, g, h, g_sv, h_sv) — h and h_sv are 0 when m == 0
IGRF13_2020 = [
